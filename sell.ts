...
import { LIQUIDITY_STATE_LAYOUT_V4, MAINNET_PROGRAM_ID, MARKET_STATE_LAYOUT_V3, LiquidityStateV4, Token, TokenAmount } from '@raydium-io/raydium-sdk';
...
const addLiquidityPool = async (): Promise<LiquidityStateV4> => {
	...
	if (args.mode === 'pool') {
		...
		const poolsAccounts = await connection.getProgramAccounts(
